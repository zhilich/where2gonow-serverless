...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *AWSServerless4*):
...
Execute unit tests
```
    cd "AWSServerless4/test/AWSServerless4.Tests"
    dotnet test
```

Deploy application
```
    cd "AWSServerless4/src/AWSServerless4"
